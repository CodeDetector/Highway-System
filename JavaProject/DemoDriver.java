...
public class DemoDriver implements AppControl {
	...
	public static void main(String[] args) {
		...
		// the group
		demoFactories.add(new demo19501.FactoryDemo());
		demoFactories.add(new demo19029.FactoryDemo());
		demoFactories.add(new demo19027.FactoryDemo());
		demoFactories.add(new demo19065.FactoryDemo());
		demoFactories.add(new demo19027.FactoryDemo());
		demoFactories.add(new demo19027.FactoryDemo());
		...
		// initialize the display (essentially for demo19027 classes of Display)
